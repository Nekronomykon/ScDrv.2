...
vtkStandardNewMacro(ElementData);
...
//----------------------------------------------------------------------------
void ElementData::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void ElementData::PrintSelfIfExists(const char * name, vtkObject *obj,
...
//----------------------------------------------------------------------------
void ElementData::Initialize()
{
  if (IsInitialized())
  {
    vtkDebugMacro(<< "ElementData @" << this
      << " already initialized.\n");
    return;
  }
...
//----------------------------------------------------------------------------
bool ElementData::GenerateHeaderFromXML(std::istream &xml,
  std::ostream &out)
{
  vtkNew<ElementData> data;
  vtkNew<ElementDataParser> parser;
  ...
  out << "// Autogenerated by ElementData::GenerateHeaderFromXML.\n"
...
//----------------------------------------------------------------------------
int ElementData::Allocate(vtkIdType sz, vtkIdType ext)
{
