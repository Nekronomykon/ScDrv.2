#include "ElementDataParser.h"

/*=========================================================================

  Program:   Visualization Toolkit
  Module:    ElementDataParser.cxx
...
//----------------------------------------------------------------------------
vtkStandardNewMacro(ElementDataParser);
...
//----------------------------------------------------------------------------
void ElementDataParser::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
void ElementDataParser::SetTarget(ElementData *bodr)
{
  vtkSetObjectBodyMacro(Target, ElementData, bodr);
}

//----------------------------------------------------------------------------
int ElementDataParser::Parse()
{
  if (!this->Target)
  {
...
//----------------------------------------------------------------------------
int ElementDataParser::Parse(const char *)
{
  return this->Parse();
}
...
//----------------------------------------------------------------------------
void ElementDataParser::StartElement(const char *name,
                                            const char **attr)
{
  if (this->GetDebug())
  {
...
//----------------------------------------------------------------------------
void ElementDataParser::EndElement(const char *name)
{
  if (strcmp(name, "atom") == 0)
  {
...
//----------------------------------------------------------------------------
void ElementDataParser::NewAtomStarted(const char **)
{
...
//----------------------------------------------------------------------------
void ElementDataParser::NewAtomFinished()
{
...
//----------------------------------------------------------------------------
void ElementDataParser::NewValueStarted(const char **attr)
{
...
//----------------------------------------------------------------------------
void ElementDataParser::NewValueFinished()
{
  this->CurrentValueType = None;
...
//----------------------------------------------------------------------------
void ElementDataParser::CharacterDataHandler(const char *data,
                                                    int length)
{
...
//----------------------------------------------------------------------------
void ElementDataParser::SetCurrentValue(const char *data, int length)
{
...
//----------------------------------------------------------------------------
void ElementDataParser::SetCurrentValue(const char *data)
{
...
//----------------------------------------------------------------------------
void  ElementDataParser::ResizeArrayIfNeeded(vtkAbstractArray *arr,
                                                    vtkIdType ind)
{
...
//----------------------------------------------------------------------------
void ElementDataParser::ResizeAndSetValue(vtkStdString *val,
                                                 vtkStringArray *arr,
                                                 vtkIdType ind)
{
  ElementDataParser::ResizeArrayIfNeeded(arr, ind);
  arr->SetValue(ind, val->c_str());
}

//----------------------------------------------------------------------------
void ElementDataParser::ResizeAndSetValue(float val,
                                                 vtkFloatArray *arr,
                                                 vtkIdType ind)
{
  ElementDataParser::ResizeArrayIfNeeded(arr, ind);
...
//----------------------------------------------------------------------------
void ElementDataParser::ResizeAndSetValue(unsigned short val,
...
//----------------------------------------------------------------------------
inline int ElementDataParser::parseInt(const char *d)
{
  return atoi(d);
}

//----------------------------------------------------------------------------
inline float ElementDataParser::parseFloat(const char *d)
{
  float value;
...
//----------------------------------------------------------------------------
inline void ElementDataParser::parseFloat3(const char *str,
                                                  float arr[3])
{
...
ElementDataParser::parseUnsignedShort(const char *d)
{
  return static_cast<unsigned short>(atoi(d));
}

//----------------------------------------------------------------------------
inline vtkStdString * ElementDataParser::ToLower(vtkStdString *str)
{
