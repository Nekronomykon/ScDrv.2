...
static inline QString keyRecentFiles() { return QStringLiteral("FileRecent"); }
...
FrameBrowser::FrameBrowser(QWidget *parent)
    : QMainWindow(parent), choose_color_(new ChooseColor(this)), files_(new ViewFilesystem(this))
{
  this->setupUi(this);
  ...
  connect(files_->getFileSelector(), &QListView::activated, this, &FrameBrowser::loadIndexedFile);
  this->updateUi();
}
//
...
void FrameBrowser::setupToolBars()
{
  ...
  connect(choose_color_, &ChooseColor::currentTextChanged, this, &FrameBrowser::setSceneBgColor);
...
void FrameBrowser::on_actionOpen__triggered()
{
  ...
  QString fmt_select;
  QFileDialog::Options options_open = QFileDialog::DontUseCustomDirectoryIcons | QFileDialog::DontUseNativeDialog;
  // QStringList paths_to_open =
  QString path_to_open = QFileDialog::getOpenFileName(this,                    // QWidget *parent
                                                      tr("Show file"),         // QString caption
                                                      frameDoc_->pathSource(), // QString dir_current
                                                      formats, &fmt_select, options_open);
...
void FrameBrowser::on_actionSetFont__triggered()
{
  ...
  bool bOk;
  QFont font_edit =
      QFontDialog::getFont(&bOk, pEdit->font(), this,
