...
QVTKMoleculeWidget::QVTKMoleculeWidget(QWidget *parent)
    : BaseWidget(parent), renderer_(OpenGLRenderer::New()), mapMolecule_(MolMapperOpenGL::New()), pickSelect_(RenderedAreaPicker::New()), styleInteractor_(IntStyleRbrBndPick::New()), mapDataAtoms_(MapLabelAtoms::New())
{
  // VTK Renderer setup
