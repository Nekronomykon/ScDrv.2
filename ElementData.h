 ...
 * static ElementData object accessible through
...
class /*VTKDOMAINSCHEMISTRY_EXPORT*/ ElementData : public vtkObject
{
public:
  vtkTypeMacro(ElementData, vtkObject);
  void PrintSelf(ostream& os, vtkIndent indent) override;
  static ElementData *New();
  ...
  //@{
  /**
   * Return the number of elements for which this ElementData
  ...
  //@{
  /**
   * Access the raw arrays stored in this ElementData.
   */
...
protected:
  friend class ElementDataParser;
...
private:
  ...
  void operator=(const ElementData&) = delete;
};
